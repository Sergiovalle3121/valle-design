...
export const CAD_ACCEPTANCE_JOURNEY: readonly CadAcceptanceJourneyStep[] = [
  ...
  { step: 9, action: 'Usar midpoint', level: 'browser-proven', evidence: [golden('28-cad-osnap-pointer.spec.ts'), golden('52-cad-draft-settings.spec.ts')] },
  ...
  { step: 35, action: 'Aplicar override de capa', level: 'browser-proven', evidence: [golden('20-cad-multiple-viewports.spec.ts'), golden('50-cad-layer-properties.spec.ts')] },
