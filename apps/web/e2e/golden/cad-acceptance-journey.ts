...
export const CAD_ACCEPTANCE_JOURNEY: readonly CadAcceptanceJourneyStep[] = [
  ...
  { step: 3, action: 'Crear capas', level: 'browser-proven', evidence: [golden('24-cad-canonical-layers.spec.ts'), golden('46-cad-layer-properties.spec.ts'), golden('26-cad-precision-polyline.spec.ts')] },
  ...
  { step: 9, action: 'Usar midpoint', level: 'browser-proven', evidence: [golden('28-cad-osnap-pointer.spec.ts'), golden('48-cad-draft-settings.spec.ts')] },
  ...
  { step: 35, action: 'Aplicar override de capa', level: 'browser-proven', evidence: [golden('20-cad-multiple-viewports.spec.ts'), golden('46-cad-layer-properties.spec.ts')] },
