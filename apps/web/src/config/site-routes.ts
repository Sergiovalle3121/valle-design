...
export const DOC_GUIDES = [
  ...
  },
  {
    ...
    description:
      `En qué se diferencian DXF y DWG, qué formato pedir a tus colaboradores y qué hace exactamente ${PRODUCT_LABEL.design} con cada uno de los dos.`,
    summary:
      `La diferencia real entre los dos formatos y el límite exacto de lo que ${PRODUCT_LABEL.design} abre y entrega.`,
  },
  {
  ...
  },
  {
    ...
    description:
      `Qué es una cota asociativa, por qué una medida escrita a mano acaba mintiendo en obra y cómo acotar en ${PRODUCT_LABEL.design} para que no pase.`,
    summary:
