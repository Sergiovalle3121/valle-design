    ...
    <GuideArticle slug="acotacion-asociativa">
      ...
      <GuideSection title="Qué significa «asociativa»">
        ...
        <p>
          ...
          ni volver a acotar. En {PRODUCT_LABEL.design} esa regeneración no es una utilidad
      ...
      <GuideSection title="Cuando el enganche se rompe, se dice">
        ...
        <p>
          Lo que hace {PRODUCT_LABEL.design} es marcar esa cota como{" "}
      ...
      <GuideSection title="Qué esperar al intercambiar el archivo">
        <p>
          ...
          importación, con la información propia que {PRODUCT_LABEL.design} registra para
          reconstruir el enganche. En un ida y vuelta dentro de {PRODUCT_LABEL.design} la
