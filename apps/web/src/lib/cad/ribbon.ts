...
const CAD_PANEL_NAME_PATTERNS: readonly [RegExp, string][] = [
  ...
  [
    /^(MOVE|COPY|ROTATE|SCALE|MIRROR|-?ARRAY|ARRAYEDIT|-?ALIGN|STRETCH|TRIM|EXTEND|FILLET|CHAMFER|BREAK|JOIN|BLEND|-?PEDIT|SPLINEDIT|OFFSET|EXPLODE|XPLODE|NCOPY|ERASE|LENGTHEN|OVERKILL|DRAWORDER|FLATTEN|3DMOVE|3DROTATE)$/,
    "Modificar",
  ],
  [
  ...
  [/^(3DORBIT|3DFORBIT|3DPAN|3DZOOM|VPOINT|PLAN|-?VIEW|PERSPECTIVE)$/, "Vistas 3D"],
