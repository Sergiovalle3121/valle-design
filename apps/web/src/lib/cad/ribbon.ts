...
const CAD_TAB_NAME_PATTERNS: readonly [RegExp, CadRibbonTabId][] = [
  ...
  [
    /^(CHECKSTANDARDS|GETVAR|SETVAR|NORMAMX|MEXSTANDARD|LAYTRANS|AUDIT|RECOVER|PURGE|RENAME|REVISA|OPTIONS)$/,
    "administrar",
  ],
...
const CAD_PANEL_NAME_PATTERNS: readonly [RegExp, string][] = [
  ...
  [/^(-?TEXT|MTEXT|DTEXT|SPELL|-?TABLE|TABLEDIT|DDEDIT|TEXTALIGN|FIELD|UPDATEFIELD)$/, "Texto y tablas"],
