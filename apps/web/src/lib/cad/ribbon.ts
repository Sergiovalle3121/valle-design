...
const CAD_TAB_NAME_PATTERNS: readonly [RegExp, CadRibbonTabId][] = [
  ...
  [
    /^(-?PLOT|PUBLISH|-?PAGESETUP|STYLESMANAGER|-?LAYOUT|MVIEW|-?VPORTS?|SOLVIEW|SOLDRAW|FLATSHOT|SOLPROF|DXFOUT|SAVEAS|EXPORT|EXPORTPDF|EXPORTLAYOUT|SHEETSET|ETRANSMIT)$/,
    "salida",
  ],
