...
const CAD_TAB_NAME_PATTERNS: readonly [RegExp, CadRibbonTabId][] = [
  ...
  [
    /^(-?XREF|XATTACH|XCLIP|XBIND|REFEDIT|ADCENTER|DESIGNCENTER|DXFIN|DXFATTACH|IMAGE|IMAGEATTACH|IMAGECLIP|IMAGEADJUST|IMPORT|DATAEXTRACTION|GEOGRAPHICLOCATION|MAPIMPORT|STDPART|STEELSHAPE|PDFATTACH|PDFIMPORT|PDFCLIP|PDFADJUST|PDFPAGE|PDFSCALE|PDFDETACH|PDFUNLOAD|PDFRELOAD|PDFLIST)$/,
    "insertar",
  ],
  [
  ...
  [
    /^(CHECKSTANDARDS|GETVAR|SETVAR|NORMAMX|MEXSTANDARD|LAYTRANS|AUDIT|RECOVER|PURGE|RENAME|OPTIONS|COMPARE)$/,
    "administrar",
  ],
...
const CAD_PANEL_NAME_PATTERNS: readonly [RegExp, string][] = [
  ...
  [/^(-?XREF|XATTACH|XCLIP|XBIND|REFEDIT|IMAGE|IMAGEATTACH|IMAGECLIP|IMAGEADJUST|PDFATTACH|PDFIMPORT|PDFCLIP|PDFADJUST|PDFPAGE|PDFSCALE|PDFDETACH|PDFUNLOAD|PDFRELOAD|PDFLIST)$/, "Referencias"],
