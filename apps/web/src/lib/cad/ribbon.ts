...
const CAD_TAB_NAME_PATTERNS: readonly [RegExp, CadRibbonTabId][] = [
  [
    /^(BOX|SPHERE|CYLINDER|CONE|WEDGE|TORUS|PYRAMID|POLYSOLID|EXTRUDE|REVOLVE|SWEEP|LOFT|PRESSPULL|UNION|SUBTRACT|INTERSECT|INTERFERE|SLICE|FILLETEDGE|CHAMFEREDGE|SOLIDEDIT|SECTION|SECTIONPLANE|MASSPROP)$/,
    "solidos3d",
  ],
  [
  ...
  [
    /^(-?PLOT|PLOTSTAMP|PUBLISH|-?PAGESETUP|STYLESMANAGER|-?LAYOUT|MVIEW|CHSPACE|-?VPORTS?|SOLVIEW|SOLDRAW|FLATSHOT|SOLPROF|DXFOUT|SAVEAS|EXPORT|EXPORTPDF|EXPORTLAYOUT|SHEETSET|ETRANSMIT)$/,
    "salida",
  ],
...
const CAD_PANEL_NAME_PATTERNS: readonly [RegExp, string][] = [
  ...
  [/^(SLICE|FILLETEDGE|CHAMFEREDGE|SOLIDEDIT|SECTION|SECTIONPLANE)$/, "Edición de sólidos"],
  ...
  [/^(-?VPORTS?|MVIEW|MSPACE|PSPACE|CHSPACE)$/, "Ventanas"],
  ...
  [/^(-?UNITS|DDPTYPE|-?OSNAP|-?DSETTINGS|SETVAR|GETVAR|OPTIONS|FILL|ORTHO|SNAP|GRID)$/, "Variables"],
  [
