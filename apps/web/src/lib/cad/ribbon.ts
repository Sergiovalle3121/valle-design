...
const CAD_TAB_NAME_PATTERNS: readonly [RegExp, CadRibbonTabId][] = [
  ...
  [
    /^(-?LAYER|LAYERSTATE|LAY(?!OUT|TRANS)[A-Z]+|VPLAYER|PROPERTIES|MATCHPROP|COLOR|-?LINETYPE|LWEIGHT|LTSCALE|CELTSCALE|-?INSERT|BLOCK|-?BEDIT|WBLOCK|ATTDEF|ATTEDIT|ATTSYNC|BURST|BASE|BLOQUEDIN|BLOQUEDINSET|BLOQUEDINLIST|GROUP|UNGROUP|DRAWORDER|QSELECT|FILTER|SELECTSIMILAR|SETBYLAYER|CHPROP)$/,
    "inicio",
  ],
  [
...
const CAD_PANEL_NAME_PATTERNS: readonly [RegExp, string][] = [
  ...
  [/^(-?INSERT|BLOCK|-?BEDIT|WBLOCK|ATTDEF|ATTEDIT|ATTSYNC|BURST|BASE|BLOQUEDIN|BLOQUEDINSET|BLOQUEDINLIST)$/, "Bloque"],
