...
const CAD_PANEL_NAME_PATTERNS: readonly [RegExp, string][] = [
  ...
  [
    /^(MOVE|COPY|ROTATE|SCALE|MIRROR|-?ARRAY|ARRAYEDIT|-?ALIGN|STRETCH|TRIM|EXTEND|FILLET|CHAMFER|BREAK|JOIN|BLEND|-?PEDIT|SPLINEDIT|OFFSET|EXPLODE|XPLODE|NCOPY|ERASE|LENGTHEN|OVERKILL|DRAWORDER|FLATTEN|3DMOVE|3DROTATE|3DALIGN|3DSCALE|MIRROR3D|3DARRAY)$/,
    "Modificar",
  ],
  ...
  [/^(3DORBIT|3DFORBIT|3DPAN|3DZOOM|VPOINT|PLAN|-?VIEW|PERSPECTIVE|3DWALK|3DFLY|3DSWIVEL|CAMERA|DVIEW|NAVVCUBE|NAVBAR)$/, "Vistas 3D"],
  ...
  [/^(PLANESURF|SURF[A-Z]+|CONVTOSURFACE|THICKEN)$/, "Superficies"],
  [/^(MESH[A-Z]*|CONVTOMESH|CONVTOSOLID|RULESURF|TABSURF|REVSURF|EDGESURF|3DFACE)$/, "Mallas"],
  ...
  [/^(RENDER|RENDERCROP|RENDERWIN|RENDERPRESETS|RENDEREXPOSURE|RENDERENVIRONMENT|MATERIALS|MATBROWSER|MATERIALMAP|MATERIALATTACH|POINTLIGHT|SPOTLIGHT|DISTANTLIGHT|SUNPROPERTIES|GEOGRAPHICLOCATION)$/, "Render"],
];
