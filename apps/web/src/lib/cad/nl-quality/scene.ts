...
const MUROS: CadBox[] = [
  ...
  asset("m-colindancia-izq", "Muro de colindancia poniente", 0, 0, 150, 20_000, "wall"),
  asset("m-colindancia-der", "Muro de colindancia oriente", 9850, 0, 150, 20_000, "wall"),
...
const PIEZAS: CadBox[] = [
  ...
  asset("p-puerta-rec", "Puerta de la recámara principal", 1200, 10_500, 900, 150, "door"),
  ...
  asset("lavabo-bano", "Lavabo del baño completo", 400, 15_200, 600, 450, "fixture"),
