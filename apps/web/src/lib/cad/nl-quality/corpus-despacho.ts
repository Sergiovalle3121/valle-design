...
const TRAZO: NlCadCase[] = [
  c(
    "d-001",
    "muro de 0,0 a 6000,0",
    "trazo por coordenadas",
    "draw_wall_segment",
    {
      from: { x: 0, y: 0 },
      to: { x: 6000, y: 0 },
  ...
  c(
    "d-004",
    "linea de 200,200 a 3200,200",
    "sinónimo de trazo",
    "draw_wall_segment",
  ),
  c(
    "d-005",
    "muro 3400,5400 @6400,0 grosor 150",
    "coordenada relativa @",
    "draw_wall_segment",
    {
      thickness: 150,
  ...
  c(
    "d-010",
    "rectangulo de 200,200 a 3200,5400",
    "cochera por rectángulo",
    "draw_rect_zone",
  ),
];
...
const COLOCAR: NlCadCase[] = [
  ...
  c(
    "d-012",
    "coloca el wc en el medio baño",
    "mueble de baño por nombre",
    "place_symbol",
    {
      query: "wc",
      into: "medio baño",
  ...
  c(
    "d-013",
    "pon la regadera en el baño completo",
    "regadera, no ducha",
    "place_symbol",
    {
      query: "regadera",
  ...
  c(
    "d-017",
    "pon un closet en cada recámara",
    "una pieza por cuarto",
    "place_symbol",
    {
      query: "closet",
      perRoom: true,
  ...
  c(
    "d-018",
    "coloca una jardinera en cada esquina",
    "esquinas del lote",
    "place_symbol",
    {
      query: "jardinera",
  ...
  c(
    "d-019",
    "pon la escalera en el patio de servicio",
    "escalera recta",
    "place_symbol",
    {
      query: "escalera",
  ...
  c(
    "d-020",
    "coloca la cisterna en el patio trasero",
    "equipo hidráulico",
    "place_symbol",
    {
      query: "cisterna",
  ...
  c(
    "d-022",
    "coloca la cama matrimonial en la recámara 2",
    "mobiliario de recámara",
    "place_symbol",
    {
      query: "cama",
    },
  ...
  c(
    "d-023",
    "pon un lavabo a la izquierda del wc",
    "ancla con lado",
    "place_symbol",
    {
      query: "lavabo",
  ...
  c(
    "d-024",
    "coloca 3 columnas en la sala-comedor",
    "estructura repetida",
    "place_symbol",
    {
      query: "columna",
...
const MOVER: NlCadCase[] = [
  c(
    "d-025",
    "centra la mesa del comedor",
    "centrado en el footprint",
    "move_selection",
    {
      center: true,
      target: "mesa",
  ...
  c(
    "d-026",
    "pega el ropero a la pared del fondo",
    "recargar contra muro",
    "move_selection",
    {
      target: "ropero",
      wall: "bottom",
  ...
  c(
    "d-027",
    "mueve el tinaco 500 a la derecha",
    "desplazamiento relativo en mm",
    "move_selection",
    {
      target: "tinaco",
      dx: 500,
  ...
  c(
    "d-028",
    "recorre el portón 2 metros a la derecha",
  ...
  c(
    "d-029",
    "mete la cama en la recámara principal",
    "destino por contenedor",
    "move_selection",
    {
  ...
  c(
    "d-030",
    "aleja el bóiler del tinaco 800",
    "alejamiento con distancia",
    "move_selection",
    {
      awayFrom: "tinaco",
      awayDist: 800,
  ...
  c(
    "d-033",
    "mueve la cisterna junto al patio de servicio",
    "destino relacional",
    "move_selection",
    {
...
const TRANSFORMAR: NlCadCase[] = [
  ...
  c(
    "d-035",
    "rota la puerta de acceso 180",
    "rotación sin la palabra grados",
    "rotate_selection",
    {
      angle: 180,
    },
  ...
  c(
    "d-036",
    "escala la mesa del comedor al 150%",
  ...
  c(
    "d-037",
    "duplica la ventana de la cocina",
  ...
  c(
    "d-040",
    "borra el sardinel de la cochera",
    "sardinel: vocabulario de obra",
    "delete_selection",
    {
      target: "sardinel",
    },
  ),
  c("d-041", "quita las ventanas", "borrado en plural", "delete_selection", {
    target: "ventana",
  }),
  c(
    "d-042",
    "cambia el tamaño del clóset a 2000x900",
    "redimensionado explícito",
    "resize_object",
    {
      w: 2000,
      h: 900,
  ...
  c("d-043", "haz la trabe 500 más ancha", "ajuste relativo", "resize_object", {
    dw: 500,
  }),
  c(
    "d-044",
    "haz el ropero del tamaño del clóset",
    "copiar medidas de otro",
    "resize_object",
    {
      like: "clóset",
    },
  ...
  c(
    "d-046",
    "renombra la Cochera a Estacionamiento",
    "rótulo nuevo",
    "rename_object",
    {
      target: "Cochera",
...
const ARREGLOS: NlCadCase[] = [
  ...
  c(
    "d-048",
    "haz un arreglo de 3 por 2 de los castillos",
    "arreglo rectangular",
    "array_rectangular",
    {
      cols: 3,
  ...
  c(
    "d-049",
    "distribuye los castillos cada 3 metros",
  ...
  c(
    "d-050",
    "alinea los castillos a la izquierda",
    "alineación",
    "align_selection",
    {
      mode: "left",
  ...
  c(
    "d-054",
    "offset del muro de fachada a 150",
    "paralela a 15 cm",
    "offset_object",
    {
      distance: 150,
  ...
  c(
    "d-055",
    "offset de 3 metros del muro de colindancia poniente",
    "paralela en metros",
    "offset_object",
    {
      distance: 3000,
...
const MEDIR: NlCadCase[] = [
  c(
    "d-056",
    "mide del Castillo K1 al Castillo K2",
    "medición de castillo a castillo",
    "measure_distance",
    {
      targetA: "Castillo K1",
      targetB: "Castillo K2",
  ...
  c("d-058", "cuántas recámaras hay", "conteo por tipo", "count_objects", {
    query: "recámara",
  }),
  c(
    "d-059",
    "¿cuántas puertas hay en cada cuarto?",
    "conteo desglosado por cuarto",
    "count_objects",
    {
      byRoom: true,
    },
  ...
  c(
    "d-060",
    "revisa si hay traslapes",
    "traslape: mexicanismo de colisión",
    "find_collisions",
  ),
  c("d-061", "valida el plano", "validación general", "validate_layout"),
  c(
    "d-062",
    "qué le falta al plano",
    "revisión de protección civil",
    "audit_plan",
  ),
  c("d-063", "cuánto mide la trabe", "consulta de dimensiones", "object_info", {
    query: "trabe",
  }),
  c("d-064", "info del tinaco", "ficha de objeto", "object_info", {
    query: "tinaco",
  }),
  c("d-065", "acota las recámaras", "acotado por objetivo", "auto_dimension", {
    target: "recámara",
  }),
  c(
    "d-066",
    "acota los claros entre los castillos",
    "acotado de claros",
    "auto_dimension",
    {
      mode: "gaps",
  ...
  c(
    "d-069",
    "crea una zona alrededor con margen de 500",
    "envolvente con margen",
    "create_zone_around",
    {
      margin: 500,
    },
...
const MUROS: NlCadCase[] = [
  c(
    "d-070",
    "extiende el muro de tablaroca hasta la trabe",
    "extensión hasta frontera",
    "extend_wall",
    {
      target: "tablaroca",
      boundary: "trabe",
  ...
  c("d-071", "recorta el muro de fachada", "recorte de muro", "trim_wall", {
    target: "fachada",
  }),
  c(
    "d-072",
  ...
  c(
    "d-074",
    "depura los muros con tolerancia de 2 mm",
    "depuración con unidad explícita",
    "cleanup_geometry",
    {
      tolerance: 2,
    },
...
const DOCUMENTO: NlCadCase[] = [
  c("d-075", "exporta el dxf", "entrega a otro despacho", "studio_export", {
    format: "dxf",
  }),
  c("d-076", "imprime en A3", "papel de obra", "studio_export", {
    format: "pdf",
    paper: "a3",
  }),
  ...
  c("d-082", "borra las cotas", "limpieza de acotado", "clear_annotations", {
    kind: "dims",
  }),
  c("d-083", "quita las notas", "limpieza de notas", "clear_annotations", {
    kind: "notes",
  }),
  c(
    "d-084",
    "escribe Patio de servicio en 2000,9000",
    "rótulo con posición",
    "add_label",
    {
  ...
  c(
    "d-086",
    "selecciona todo menos los castillos",
    "selección con exclusión",
    "select_objects",
    {
      exclude: "castillo",
    },
  ),
  c("d-087", "enfoca la cochera", "encuadre por nombre", "fit_to_view", {
    target: "cochera",
  }),
  c("d-088", "ayuda", "descubrimiento de comandos", "help_commands"),
  c("d-089", "exporta png", "imagen para el cliente", "studio_export", {
    format: "png",
  }),
  c("d-090", "exporta el 3d", "entrega de modelo", "studio_export", {
    format: "glb",
  }),
];
...
const SIN_ACENTOS: NlCadCase[] = [
  ...
  c(
    "d-092",
    "enfoca la recamara principal",
    "sin acentos: encuadre",
    "fit_to_view",
    {
      target: "recamara principal",
    },
  ),
  c("d-093", "cuantas ventanas hay", "sin acentos: conteo", "count_objects", {
    query: "ventana",
  }),
  c(
    "d-094",
    "mueve el boiler 300 a la derecha",
    "sin acentos: bóiler",
    "move_selection",
    {
      target: "boiler",
  ...
  c(
    "d-095",
    "pon un closet en la recamara 2",
    "sin acentos: clóset",
    "place_symbol",
    {
      query: "closet",
  ...
  c(
    "d-098",
    "coloca el wc en el medio bano",
    "sin acentos y con la eñe tecleada como n",
    "place_symbol",
    {
      query: "wc",
      into: "medio bano",
