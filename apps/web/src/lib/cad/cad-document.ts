/**
 * Documento CAD canónico de VALLECAD CAD (CAD-NEXT-010).
 *
...
/**
 * Versionado y serialización determinista: viven en `cad-document-serialize.ts`
 * (salieron por el trinquete de tamaño). Se reexportan aquí porque son la
 * puerta pública de siempre.
 */
export { commitChange, serializeCadDocument } from "./cad-document-serialize";
