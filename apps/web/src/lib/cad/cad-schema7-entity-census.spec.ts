...
// --- 2. y 3. guardar → abrir no pierde NI UN TIPO ----------------------------
{
  ...
  assert.equal(abierto.meta.schema, CAD_DOCUMENT_SCHEMA, "el documento abierto debe declararse el esquema vigente");
}
...
// --- 4. un documento del esquema 6 sigue abriendo ----------------------------
{
  ...
  assert.equal(migrado.meta.schema, CAD_DOCUMENT_SCHEMA, "el v6 debe pasar a declararse el esquema vigente al abrirse");
