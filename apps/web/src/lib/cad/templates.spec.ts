...
for (const id of ["casa-habitacion", "local-comercial", "consultorio", "restaurante", "aula-escolar", "gimnasio", "oficina-coworking", "bodega-pyme", "taller-mecanico", "cafeteria", "salon-belleza", "farmacia", "jardin-eventos", "panaderia", "veterinaria", "lavanderia", "guarderia", "ferreteria", "habitacion-hotel", "consultorio-dental", "estacionamiento", "cancha-futbol"]) {
