...
export const CAD_COMMAND_LABELS: Readonly<Record<string, string>> = {
  ...
  ALIGN: "Alinear",
  ANNORESET: "Restablecer",
  ANNOSCALE: "Escala anotativa",
  ARC: "Arco",
  AREA: "Área",
  ARRAY: "Matriz",
  ...
  TABLEEXPORT: "Exportar CSV",
  TABLESTYLE: "Estilo de tabla",
  TINSERT: "Filas y columnas",
  TABSURF: "Tabulada",
