...
export const CAD_COMMAND_SUMMARIES: Readonly<Record<string, string>> = {
  ...
  CAMERA: "Define la posición de la cámara y el objetivo para el visor 3D.",
  ...
  DISTANTLIGHT: "Crea una luz direccional (sol simulado) en la escena.",
  ...
  DVIEW: "Vista dinámica: selecciona objetos y define cámara, objetivo o distancia de forma interactiva.",
  ...
  MATERIALS: "Abre el explorador de materiales.",
  MATERIALATTACH: "Adjunta un material a las entidades seleccionadas.",
  MATERIALMAP: "Mapea un material con método de proyección (plano, caja, cilindro, esfera).",
  ...
  NAVBAR: "Barra de navegación 3D: órbita, paneo, zoom y animación de vistas.",
  NAVVCUBE: "Cubo de navegación 3D: clic en cara, arista o vértice para orientar la vista.",
  ...
  POINT: "Punto aislado.",
  POINTLIGHT: "Crea una luz puntual omnidireccional en la escena.",
  ...
  RENDER: "Captura el viewport actual a una imagen.",
  RENDERCROP: "Captura una región recortada del viewport a imagen.",
  RENDERENVIRONMENT: "Cambia el fondo y la iluminación ambiental del render.",
  RENDEREXPOSURE: "Ajusta la exposición del render (-3 a +3).",
  RENDERPRESETS: "Cambia la calidad del motor de render.",
  RENDERWIN: "Abre una ventana de previsualización de render.",
  ...
  MESHCOLLAPSE: "Simplifica una malla colapsando su arista más corta.",
  ...
  SPOTLIGHT: "Crea un foco direccional concono en la escena.",
  ...
  SUNPROPERTIES: "Ajusta altitud, azimuth e intensidad del sol.",
