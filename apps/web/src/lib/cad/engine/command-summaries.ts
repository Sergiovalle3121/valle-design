...
export const CAD_COMMAND_SUMMARIES: Readonly<Record<string, string>> = {
  ...
  ABOUT: "Muestra el nombre, la versión y la dirección del producto.",
  "3DFORBIT": "Órbita 3D libre, sin restricción de eje.",
  "3DMOVE": "Mueve sólidos 3D con un desplazamiento definido por dos puntos.",
  "3DORBIT": "Órbita 3D alrededor del modelo.",
  "3DPAN": "Encuadre de la vista 3D.",
  "3DROTATE": "Gira sólidos 3D alrededor de un eje definido por dos puntos.",
  ...
  AESYMBOL: "Coloca un símbolo de esquema eléctrico IEC 60617 en el dibujo.",
  ALIGN: "Alinea objetos con otros por pares de puntos de origen y destino.",
  ANNORESET: "Devuelve el texto de las cotas anotativas designadas a su posición calculada, sin la anulación manual.",
  ANNOSCALE: "Fija la escala de anotación del documento: reescala texto, cotas y sombreados anotativos a 1:x.",
  ...
  BREAK: "Parte un objeto en dos puntos, con hueco real entre ellos.",
  BREAKATPOINT: "Parte un objeto en un solo punto, sin dejar hueco.",
  ...
  CENTERLINE: "Línea de centro entre dos líneas o arcos seleccionados.",
  CENTERMARK: "Marca de centro de un círculo o arco: dibuja la cruz de ejes.",
  CELTSCALE: "Escala de tipo de línea de los objetos nuevos.",
  CAMERA: "Aún no disponible: el dibujo no guarda cámaras. Para orientar la vista, 3DORBIT o VPOINT.",
  ...
  CHSPACE: "Mueve objetos entre espacio modelo y papel conservando su tamaño aparente.",
  ...
  DIMDISASSOCIATE: "Quita la asociatividad de las cotas designadas: sus puntos dejan de seguir a la geometría.",
  DIMEDIT: "Edita texto y oblicuidad de cotas existentes.",
  DIMJOGGED: "Cota de radio con quiebre, para un centro fuera del plano.",
  ...
  DIMREASSOCIATE: "Vuelve a enganchar cotas huérfanas (o designadas) a nuevos puntos de definición, uno a uno.",
  DIMSPACE: "Iguala o cierra el espacio entre cotas paralelas ya colocadas.",
  DIMSTYLE: "Gestor de estilos de cota.",
  DIMTEDIT: "Mueve el rótulo de una cota: izquierda, derecha, centro, inicio o ángulo.",
  DIST: "Distancia y ángulo entre dos puntos.",
  DISTANTLIGHT: "Aún no disponible: el dibujo todavía no guarda luces y el visor 3D no las pinta.",
  ...
  GRID: "Enciende, apaga o cambia el paso de la rejilla, tecleado en un solo paso.",
  GROUP: "Agrupa la selección en un grupo con nombre.",
  HATCH: "Sombreado de un contorno con patrón o relleno sólido.",
  HATCHORIGIN: "Fija el origen del patrón de los sombreados designados, para que casen en fase entre sí.",
  ...
  LAYCUR: "Designa un objeto para convertir su capa en la capa actual.",
  ...
  MATERIALS: "Aún no disponible: el dibujo todavía no guarda materiales.",
  MATERIALATTACH: "Aún no disponible: el dibujo todavía no guarda materiales por objeto.",
  MATERIALMAP: "Aún no disponible: el dibujo todavía no guarda materiales ni su mapeado.",
  ...
  COGO: "Levanta una poligonal desde rumbos y distancias, y declara su cierre, su precisión 1:N y su superficie.",
  CUADROCONSTRUCCION: "Emite el cuadro de construcción de una polilínea cerrada como TABLE: rumbo, distancia, X, Y y superficie.",
  ...
  VECTORIZE: "Convierte un escaneo adjunto en geometría: polilíneas por umbral y los rótulos trazados como TEXT.",
  ...
  OBJECTSCALE: "Agrega o quita la escala anotativa de los objetos designados.",
  OFFSET: "Paralela a distancia exacta de la selección.",
  OPTIONS: "Opciones del editor.",
  ORTHO: "Enciende o apaga el modo orto, tecleado en un solo paso: la misma ORTHOMODE del botón.",
  ...
  REDRAW: "Redibuja la vista actual sin recalcular.",
  REGEN: "Regenera la vista actual.",
  REGENALL: "Regenera todas las vistas.",
  REGION: "Convierte contornos cerrados en regiones.",
  RENDER: "Aún no disponible: VALLECAD todavía no tiene motor de render. Para ver el modelo sombreado, VSCURRENT.",
  RENDERCROP: "Aún no disponible: no hay motor de render que produzca la imagen de una región.",
  RENDERENVIRONMENT: "Aún no disponible: no hay motor de render cuyo fondo o iluminación cambiar.",
  RENDEREXPOSURE: "Aún no disponible: no hay motor de render cuya exposición ajustar.",
  RENDERPRESETS: "Aún no disponible: no hay motor de render cuya calidad ajustar.",
  RENDERWIN: "Aún no disponible: no hay ventana de render que abrir.",
  RENAME: "Renombra capas, bloques, estilos y demás tablas.",
  REVCLOUD: "Nube de revisión.",
  REVERSE: "Invierte el sentido de una LINE, POLYLINE o SPLINE: el primer vértice pasa a ser el último.",
  ...
  SNAP: "Enciende, apaga o cambia el paso del forzado de cursor, tecleado en un solo paso.",
  SOLDRAW: "Dibuja dentro de las vistas creadas por SOLVIEW.",
  SOLID: "Triángulos y cuadriláteros rellenos 2D.",
  // El renglón nombra las OCHO ramas construidas. La redacción de la petición
  // («Edición de sólidos: … copiar las aristas …») medía 124 caracteres y el
  // contrato de la paleta corta en 110: se acorta el texto, no el gate.
  SOLIDEDIT: "Sólidos: extruir, desfasar o copiar una cara, copiar aristas, comprobar, separar, limpiar o vaciar un cuerpo.",
  SOLPROF: "Perfil 2D de un sólido en la ventana.",
  SOLVIEW: "Ventanas de vistas derivadas del sólido: planta, alzado, sección.",
  VIEWBASE: "Vista base del modelo 3D: planta cortada o alzado, con escala.",
  VIEWPROJ: "Proyecta una vista existente en dirección ortogonal.",
  VIEWSECTION: "Sección transversal por línea de corte de dos puntos.",
  ...
  SURFUNTRIM: "Aún no disponible: el núcleo no rehace bordes de superficie. Se niega sin tocar el dibujo.",
  ...
  SURFSCULPT: "Aún no disponible: el núcleo no convierte superficies en sólido. Se niega sin tocar el dibujo.",
  ...
  MESHSMOOTH: "Suaviza una malla subdividiendo sus caras.",
  MESHSMOOTHMORE: "Aumenta el nivel de suavidad de una malla.",
  MESHSMOOTHLESS: "Reduce el nivel de suavidad de una malla.",
  MESHREFINE: "Refina una malla subdividiendo todas sus caras.",
  MESHCOLLAPSE: "Aún no disponible: el núcleo no colapsa caras ni aristas. Se niega sin tocar el dibujo.",
  MESHCAP: "Tapa los bordes abiertos de una malla.",
  ...
  "3DWALK": "Aún no disponible: el visor 3D no tiene modo de paseo. Para girar la vista, 3DORBIT.",
  "3DFACE": "Crea una cara 3D (triángulo o cuadrilátero) a partir de 3 o 4 puntos.",
  "3DFLY": "Aún no disponible: el visor 3D no tiene modo de vuelo. Para girar la vista, 3DORBIT.",
  "3DSWIVEL": "Aún no disponible: la cámara no gira sobre sí misma. Para girar la vista, 3DORBIT.",

  VISUALSTYLES: "Aún no disponible: no hay administrador de estilos visuales. Para cambiar el estilo, VSCURRENT.",
  ...
  SPOTLIGHT: "Aún no disponible: el dibujo todavía no guarda luces y el visor 3D no las pinta.",
  ...
  STATUS: "Muestra el número de entidades, capas y bloques del dibujo.",
  SUBTRACT: "Resta booleana de sólidos o regiones.",
  SUNPROPERTIES: "Aún no disponible: el visor 3D todavía no simula el sol.",
  SWEEP: "Sólido por barrido de un perfil a lo largo de un camino.",
  TABLE: "Tabla editable con filas y columnas.",
  TABLEDIT: "Cambia el texto o la fórmula de una celda de una tabla, con recálculo.",
  TABLEEXPORT: "Exporta una tabla del dibujo a un archivo CSV.",
  TABLESTYLE: "Gestor de estilos de tabla.",
  TINSERT: "Inserta o borra filas y columnas de una tabla, y fusiona celdas.",
  TABSURF: "Extruye un perfil a lo largo de una trayectoria (superficie tabulada).",
  ...
  VPORTS: "Divide el visor de espacio modelo en varias ventanas con su propia cámara.",
