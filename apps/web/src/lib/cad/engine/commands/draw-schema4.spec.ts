...
// --- DEFINICIÓN DE TERMINADO: se dibuja, se guarda, se reabre y sigue ahí ----
{
  ...
  // El esquema vigente es el 6 desde la ola BIM del muro. La migración es
  // aditiva: un documento escrito como v4 se reabre como v6 sin perder un campo,
  // y lo único que cambia es este número.
  assert.equal(reopened.meta.schema, 6);
