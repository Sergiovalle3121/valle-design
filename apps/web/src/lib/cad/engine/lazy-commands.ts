...
export const CAD_COMMAND_MODULE_LOADERS = {
  ...
  "commands/annotate-table-export": () => import("./commands/annotate-table-export"),
  "commands/annotate-table-structure": () => import("./commands/annotate-table-structure"),
  "commands/annotate-text": () => import("./commands/annotate-text"),
  "commands/annotate-tolerance": () => import("./commands/annotate-tolerance"),
  "commands/annotative-scale-commands": () => import("./commands/annotative-scale-commands"),
  ...
  "commands/chspace-command": () => import("./commands/chspace-command"),
  ...
  "commands/hatch-origin-commands": () => import("./commands/hatch-origin-commands"),
  ...
  "commands/transform-3d-mirror": () => import("./commands/transform-3d-mirror"),
  "commands/transform-3d-array": () => import("./commands/transform-3d-array"),
  "commands/transform-3d-align": () => import("./commands/transform-3d-align"),
  ...
  "commands/settings-layer-vplayer": () => import("./commands/settings-layer-vplayer"),
  ...
  "commands/vports-command": () => import("./commands/vports-command"),
  ...
  "commands/utility-commands": () => import("./commands/utility-commands"),
  "commands/text-search": () => import("./commands/text-search"),
} as const;
