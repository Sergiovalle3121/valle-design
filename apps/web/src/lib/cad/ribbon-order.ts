...
export const CAD_RIBBON_COMMAND_ORDER: Readonly<Record<string, readonly string[]>> = {
  ...
  Mallas: ["MESH", "RULESURF", "TABSURF", "REVSURF", "EDGESURF", "MESHSMOOTH", "MESHSMOOTHMORE", "MESHSMOOTHLESS", "MESHREFINE", "MESHCOLLAPSE", "MESHCAP", "MESHMERGE", "MESHSPLIT", "MESHUNCREASE"],
