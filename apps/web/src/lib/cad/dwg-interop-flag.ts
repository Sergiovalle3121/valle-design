...
// los tres de arriba. Firmada 2026-09-16 (ADR-0009 §9).
// ---------------------------------------------------------------------------
 ...
 * exactamente esto.
 *
 * Firmada por el titular el 2026-09-16 (orden explícita en `.mimocode/cola-vallecad.md`
 * T10), siguiendo el mismo patrón de conversación registrada que ya tenían V1/V2/V3
 * y M3. La conjunción de tres condiciones ahora devuelve `true` cuando las tres
 * se cumplen.
 *
...
export interface DwgModernBetaAuthorization {
  readonly ownerSigned: true;
  readonly adrRef: "0009";
  readonly signedDate: "2026-09-16";
