// Los tipos de flujo son contrato del kernel CAD (analysis-extensions); aquí
// vive el ALGORITMO industrial, que el host registra como extensión.
import type {
  CadFlowNode,
  CadFlowSegment,
  CadFlowScoreSummary,
