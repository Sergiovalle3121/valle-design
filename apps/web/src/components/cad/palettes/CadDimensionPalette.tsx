...
export function CadDimensionPalette({
  selectedCount,
  defaultOffset,
  styles,
  onCreate,
  docked,
}: CadDimensionPaletteProps) {
  ...
  return (
    <div
      data-testid="cad-dimension-palette"
      className={
        docked
      ...
      <div className="grid grid-cols-2 gap-2">
        <label className="col-span-2 text-muted-foreground">
          ...
          >
            ...
            <option value="ordinate">Ordinate</option>
      ...
      <label className="mt-2 flex items-center gap-2 text-foreground">
        <input
          ...
          onChange={(event) =>
            setDraft((current) => ({
              ...current,
              extensionLines: event.target.checked,
            }))
          }
