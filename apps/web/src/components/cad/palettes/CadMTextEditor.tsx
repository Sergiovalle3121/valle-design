...
export function CadMTextEditor(props: CadMTextEditorProps) {
  ...
  useEffect(
    ...
    [
      props.initial,
      props.defaultInsertion.x,
      props.defaultInsertion.y,
      props.defaultHeight,
      props.defaultLayer,
      props.textStyles,
    ],
  ...
  return (
    ...
    >
      ...
      <div className="mt-2 flex flex-wrap gap-1">
        ...
        <button
          data-testid="cad-mtext-background-mask"
          aria-pressed={draft.backgroundMask}
          onClick={() =>
            setDraft((current) => ({
              ...current,
      ...
      <div className="mt-3 grid grid-cols-4 gap-2 type-micro text-muted-foreground">
        ...
        <label>
          Rotación
          <input
            data-testid="cad-mtext-rotation"
            type="number"
        ...
        <label>
          Interlineado
          <input
            data-testid="cad-mtext-line-spacing"
            type="number"
            min="0.5"
            max="4"
            step="0.05"
        ...
        <label className="col-span-2">
          Attachment
          <select
            data-testid="cad-mtext-alignment"
        ...
        <label className="col-span-2">
          Párrafo
          <select
            data-testid="cad-mtext-paragraph"
            value={draft.paragraphAlignment}
            onChange={(event) =>
              setDraft((current) => ({
                ...current,
                paragraphAlignment: event.target
        ...
        <label className="col-span-2">
          Estilo
          <input
            data-testid="cad-mtext-style"
            list="cad-mtext-styles"
            value={draft.style}
            onChange={(event) =>
