...
- Herramientas de IA utilizadas y alcance:
- Entrada correspondiente en `docs/governance/assisted-development-log.json`:
- Revisión humana/adopción prevista:
- [ ] La persona responsable revisó el diff y responde por su procedencia.
- [ ] No añadí una IA como autora ni copropietaria; si hay trailer de
      atribución de herramienta, es sólo atribución operativa según
      `docs/governance/ASSISTED_DEVELOPMENT.md`.

## Dependencias y cadena de suministro

- Dependencias nuevas/cambiadas y justificación:
- Licencias y notices:
