...
export const residueBacklog = [
  ...
  ["apps/web/src/lib/cad/command-line-assist.ts", "ola 5"],
  ["apps/web/src/lib/cad/commands/parser.ts", "ola 5"],
  ["apps/web/src/lib/cad/commands/registry.spec.ts", "ola 5"],
  ["apps/web/src/lib/cad/commands/registry.ts", "ola 5"],
  ["apps/web/src/lib/cad/commands/types.ts", "ola 5"],
  ["apps/web/src/lib/cad/dxf-layer-map.ts", "ola 5"],
  ["apps/web/src/lib/cad/editor-snapshot.spec.ts", "ola 5"],
  ["apps/web/src/lib/cad/nl-quality/corpus-despacho.ts", "ola 5"],
