...
| ci-fallo (build) | Hallazgo falso: ci-fallo.md decía TS2554 en outbox-receiver.service.ts:78 (4 args, función acepta 3). Al revisar, `renderEmailTemplate` ya tiene4 parámetros (brand con default) — el fallo era de un estado anterior resuelto por los commits vc-correo ya en la rama. No había nada que arreglar. ci-fallo.md borrado. | — |
