...
| F7 · Modelado 3D (abierto 20:40 UTC) | `lib/cad/interop/` (escritores de malla nuevos), `glb-export.ts`, `engine/commands/{solids-interop,solids-transform}.ts`, `solid3d-build.ts`, `solid3d-adapter.ts`, `cad-entities-v5.ts` (aditivo), entradas aditivas en `commands/registry.ts` y `engine/lazy-commands.ts` | `claude/f7-modelado-3d` | 200-209 |
