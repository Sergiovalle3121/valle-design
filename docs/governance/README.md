...
La topología aprobada es un único repositorio privado,
`Sergiovalle3121/valle-design`; esta gobernanza no depende de un repositorio
compañero ni presume que ya exista un corpus DWG.
