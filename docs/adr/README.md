...
| [0009](0009-dwg-promotion-package.md) | Paquete de evidencia para promover el códec DWG propio a producto. | **Propuesta** — pendiente de la firma del dueño |
...
| [0012](0012-dwg-doble-via.md) | DWG a doble vía: licenciar para VENDER, códec propio para POSEER, con criterio de cambio escrito. | Aceptada |
