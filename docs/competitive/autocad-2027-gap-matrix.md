...
| ---: | ---: | ---: | --- | --- |
| 1 | 1 | 3 | Capas y propiedades | Congelar de verdad: `frozen` en la capa del documento canónico (CadLayerDef), distinto de apagar, persistido y con viaje DXF del bit 1 del código 70 |
| 2 | 1 | 3 | Layouts, viewports y publicación | El sombreado llega al PDF publicado con su patrón, no sólo el contorno |
| 3 | 2 | 8 | Compare, comentarios y enlaces de revisión | Carga concurrente medida y merge semántico con recorrido de todos los roles, con veredicto verde en el artefacto |
| 4 | 2 | 10 | Import/export DXF de texto | Corpus DXF de terceros, autorizado y diverso, con matriz por entidad y pérdidas aceptadas |
| 5 | 1 | 5 | Selección y modificación | Estrés de navegador con trazos densos (100k) sobre selección y modificación, con artefacto versionado por corrida |
| 6 | 1 | 6 | MTEXT y texto | Una fuente de trazos (SHX o equivalente de dominio público) resuelve glifos de verdad en vez de sustituirse |
| 7 | 2 | 12 | Rendimiento 10k/100k | SLO de navegador CUMPLIDO, no sólo publicado: detalle completo ≤5 s, paneo ≥30 fps p95 y zoom asentado ≤500 ms sobre el corpus architecture (perfil next, 10k), con hardware y navegador declarados |
| 8 | 1 | 8 | Eventos e integración asíncrona | Evidencia operacional sostenida y replay auditado con receptor externo |
| 9 | 3 | 60 | Import/export DWG | Decoder productivo con corpus independiente y matriz de entidades |
| 10 | 2 | 40 | Import/export DWG | Exportación DWG con round-trip verificado por lector externo |
