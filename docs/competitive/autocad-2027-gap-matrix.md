...
| 7 | 1 | 30 | Kernel Rust/WASM | Kernel WASM con paridad numérica verde Y enchufado: alguien fuera de lib/cad/wasm lo importa (regla 6) |
| 8 | 2 | ? | Toolset Raster Design (mitad útil) | Vectorizar líneas y textos de un escaneo a entidades |
