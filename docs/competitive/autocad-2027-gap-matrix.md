...
| Import/export DXF de texto       |   9/12 | Parcial | Importador y exportador TS, manifiesto de pérdidas, preflight, round-trip por entidad, XDATA registrada, corpus propio; goldens 27 y 34                                     | Corpus de terceros autorizado con matriz por entidad; DXFIN/DXFOUT no son tecleables                           |
