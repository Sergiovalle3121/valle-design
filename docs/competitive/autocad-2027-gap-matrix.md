...
| Xrefs | 5/6 | Parcial | Referencias externas declaradas en el documento canónico; Resolución de recursos y bind con round-trip; Las capas de la xref sobreviven: apagar, congelar y atenuar una capa del plano ajeno sin tocar las demás (VISRETAIN); XREF, XATTACH, XBIND y XCLIP tecleables — y XATTACH deja la referencia en el documento que recibe el servidor | Nada pendiente: todos los criterios declarados verifican |
