...
**Puntuación (rúbrica 2026-09-03.1).** **Alcance de HOY: 175/197 (88.8 %)** — el flujo diario de dibujo 2D técnico, la cifra que se enseña a un cliente. **Alcance de DESTINO: 230/271 (84.9 %)** — AutoCAD completo con sus verticales, la cifra que mide el camino; lo excluido de hoy es «todavía no», nunca «nunca». 5 pt provienen de evidencia INDEPENDIENTE y 225 pt sólo de evidencia propia; 27 fila(s) retienen 1 pt hasta tener evidencia independiente. 0 de 36 filas están en su tope. Una fila sólo llega a su tope cuando TODOS sus criterios verifican, incluidos los que nombran gaps documentados; un gap conocido se declara como criterio que falla, no como nota al pie.
...
### Los siete toolsets de AutoCAD — 19/28
...
| Toolset Plant 3D | 2/4 | Parcial | Diagramas P&ID: catálogo de equipos etiquetados y líneas numeradas, todo derivado del dibujo | Tubería 3D por especificación e isométricos (2 pt) |
...
| 4 | 1 | 8 | Rendimiento 10k/100k | La mezcla architecture@100k cumple el mismo SLO: detalle completo ≤5 s y paneo ≥30 fps p95 |
| 5 | 1 | 12 | Bloques y atributos | Bloques dinámicos (parámetros y acciones de AutoCAD) y comportamiento anotativo |
...
| 9 | 2 | ? | Toolset Plant 3D | Tubería 3D por especificación e isométricos |
| 10 | 2 | ? | Toolset Raster Design (mitad útil) | Vectorizar líneas y textos de un escaneo a entidades |
