...
### Comprar, crecer, entrar y salir: lo que decide un despacho — 4/12
...
| Facturación declarada con su límite | 2/3 | Parcial | «Factura CFDI» sólo se anuncia cuando el proveedor de timbrado no está en modo manual: el sello de la portada y la respuesta del FAQ se derivan del descriptor, con una prueba que lo impide en modo manual; Reembolsos y disputas llegan por webhook firmado y dejan asiento verificable | Cada plantilla de correo que el árbol encola tiene renderizador: un gate de cobertura recorre todos los nombres encolados y ninguno se descarta en silencio (1 pt) |
