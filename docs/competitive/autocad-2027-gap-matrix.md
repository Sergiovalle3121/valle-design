...
### Comprar, crecer, entrar y salir: lo que decide un despacho — 6/12
...
| El expediente que pide un comprador | 2/3 | Parcial | El cliente puede leer quién tocó sus planos: GET /v1/organizations/{id}/audit-log con pantalla, aislamiento por inquilino probado, retención y purga declaradas; El SLA se publica y sus nombres de plan son los del catálogo vendible, atados por una prueba | Exportación de datos personales y borrado de cuenta (derechos ARCO/RGPD) con contrato, ruta y prueba (1 pt) |
