...
3. **Tipos de línea con su forma completa.** Guardar el patrón entero en vez del primer par en `cad-effective-style.ts:207-227`, y subir `CAD_LINETYPE_SLOT_LIMIT` por encima de 8 — una plantilla de ejecutivo mexicano lleva más de ocho.
